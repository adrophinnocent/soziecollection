...
@section('title', (isset($address) ? __('Edit Address') : __('Add New Address')).' | Sozie Collection')

@section('content')
@php
    $isEdit = isset($address);
    $pageTitle = $isEdit ? __('Edit Saved Address') : __('Add New Shipping Address');
    $subtitle = $isEdit
        ? __('Update details for this saved delivery location. Changes apply immediately at your next Sozie Collection checkout.')
        : __('Add a new delivery location to your Sozie Collection address book for ultra-fast 1-click checkout on future orders.');
@endphp
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div class="sm:col-span-2">
                <label for="street_address" class="block text-[10px] font-extrabold text-[#A8895F] uppercase tracking-[0.25em] mb-2">
                    {{ __('Full Street & Delivery Details') }}
                </label>
