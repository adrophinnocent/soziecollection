...
<body class="bg-[#EDE5D8] text-[#29241F] font-sans min-h-screen flex">

    <aside class="w-64 bg-[#F8F5EF] border-r border-[#D8C9B8] flex flex-col justify-between p-6 flex-shrink-0 shadow-sm">
        <div class="space-y-8">
            ...
            <nav class="space-y-2 text-xs font-bold tracking-wider uppercase">

                <a href="{{ route('admin.dashboard') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                        <i data-lucide="layout-dashboard" class="w-4 h-4 text-[#A8895F]"></i>
                        <span>Dashboard</span>
                    </div>
                    @if(request()->routeIs('admin.dashboard'))
                    <span class="w-1.5 h-1.5 rounded-full bg-[#A8895F]"></span>
                    @endif
                </a>

                @can('products')
                <a href="{{ route('admin.products') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.products*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.orders') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.orders*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.customers') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.customers*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.marketing') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.marketing*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.reports') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.reports*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.content') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.content*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.users') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.users*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.payments') }}"
                   class="flex items-center justify-between px-3.5 py-2.5 rounded polygon-btn transition-all {{ request()->routeIs('admin.payments*') ? 'bg-[#29241F] text-[#EDE5D8] font-extrabold shadow-sm' : 'text-[#29241F] hover:text-[#A8895F] hover:bg-[#A8895F]/10' }}">
                    <div class="flex items-center gap-3">
    ...
    <div class="flex-grow flex flex-col min-w-0">
        ...
        <header class="bg-[#F8F5EF] border-b border-[#D8C9B8] px-8 py-4 flex justify-between items-center shadow-xs sticky top-0 z-30">
            <div>
                <span class="text-[10px] text-[#A8895F] font-extrabold uppercase tracking-[0.25em] block">SOZIE ATELIER MANAGEMENT</span>
                <h2 class="font-serif font-bold text-xl text-[#29241F]">@yield('page_title', 'Dashboard Overview')</h2>
            </div>
