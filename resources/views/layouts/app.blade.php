        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="https://wa.me/255700000000?text=Jambo%20Sozie%20Collection%20!"
                       target="_blank"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-14">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex space-x-3 pt-1">
                        ...
                        <!-- WhatsApp -->
                        <a href="https://wa.me/255700000000" target="_blank" title="WhatsApp Concierge" class="w-9 h-9 rounded bg-emerald-950/80 border border-emerald-600/50 flex items-center justify-center text-emerald-300 hover:bg-emerald-900 transition-all shadow-md">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-xs text-[#D8C9B8] font-medium">
                        ...
                        <li><a href="https://wa.me/255700000000" target="_blank" class="hover:text-[#FFF5D0] transition-colors flex items-center gap-1.5 group"><span class="w-1 h-1 rounded-full bg-[#C5A059]/40 group-hover:bg-[#D4AF37] transition-colors"></span> VIP WhatsApp Concierge</a></li>
