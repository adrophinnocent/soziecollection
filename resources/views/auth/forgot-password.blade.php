...
@section('title', 'Forgot Password | Sozie Collection')
...
<div class="py-24 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="glass-panel-gold p-8 sm:p-12 polygon-card border-2 border-[#A8895F]/40 shadow-2xl bg-[#F8F5EF] text-center">
        ...
        <span class="text-[10px] font-extrabold text-[#A8895F] uppercase tracking-[0.35em] block mb-3">PASSWORD RECOVERY</span>
        <h1 class="font-serif font-bold text-4xl text-[#29241F] mb-4">Forgot Your Password?</h1>
        <p class="text-sm text-gray-600 font-medium leading-relaxed mb-8 max-w-md mx-auto">
            No worries. Enter the email address associated with your Sozie Collection account and we'll send you a secure link to reset your password.
        </p>
