...
@section('title', __('Track Order | Sozie Collection'))
...
<div class="py-16 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="glass-panel p-8 polygon-card border border-[#D8C9B8] space-y-6 bg-[#F8F5EF] shadow-lg">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center py-3">
            @php
                $statuses = [
                    ['code' => 'placed', 'label' => __('Placed'), 'icon' => 'clipboard-list'],
                    ['code' => 'processing', 'label' => __('Preparing'), 'icon' => 'flask-conical'],
                    ['code' => 'shipped', 'label' => __('Shipped'), 'icon' => 'truck'],
                    ['code' => 'delivered', 'label' => __('Delivered'), 'icon' => 'gift'],
                ];
            ...
            <div class="space-y-2">
                ...
                <div class="space-y-0.5">
                    ...
                    <span class="block text-[9px] text-[#A8895F] font-extrabold uppercase tracking-widest animate-pulse">{{ __('Now') }}</span>
                    @endif
                </div>
            </div>
            @endforeach
